...
if (!function_exists('landing_page_content')) {
  function landing_page_content() {
    luca()->getModule('columns')->renderBlock('landing-columns', 'default', ['wrapper' => 'section section-frontColumns', 'container' => true, 'modifier' => 'mod-flowOverTop']);

    luca()->getModule('textarea')->renderBlock('landing-textarea', 'default', ['wrapper' => 'section section-landingTextarea', 'container' => true]);

    get_template_part('templates/front/columns-background');

    get_template_part('templates/front/newsletter');

    luca()->getModule('testimonials')->renderBlock('landing-testimonials', 'default', ['wrapper' => 'section section-frontTestimonials', 'container' => false]);

    luca()->getModule('logos')->renderBlock('landing-logos', 'default', ['wrapper' => 'section section-frontLogos', 'container' => true]);
  }
}
